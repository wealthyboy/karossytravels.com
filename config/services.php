...
return [
    ...
    'google' => [
        ...
        'timeout' => (int) env('GOOGLE_AUTH_TIMEOUT', 15),
    ],
    ...
    'travel' => [
        ...
        'travel_api' => [
            ...
            'booking_get_path' => env('TRAVEL_API_BOOKING_GET_PATH', '/v1/trip/orders/getBooking'),
            'flight_ticket_fulfill_path' => env('TRAVEL_API_FLIGHT_TICKET_FULFILL_PATH', '/v1/trip/orders/fulfillFlightTickets'),
            'auto_ticket_paid_bookings' => filter_var(env('TRAVEL_API_AUTO_TICKET_PAID_BOOKINGS', true), FILTER_VALIDATE_BOOL),
            ...
            // Hotel Price Check is a separate v4 CSL operation. It is not
            // nested beneath the v5 GetHotelAvail endpoint.
            'hotel_price_check_path' => env('TRAVEL_API_HOTEL_PRICE_CHECK_PATH', '/v4.0.0/hotel/pricecheck'),
            'hotel_booking_path' => env('TRAVEL_API_HOTEL_BOOKING_PATH', '/v2.5.0/passenger/records?mode=create'),
            'iata_number' => env('TRAVEL_API_IATA_NUMBER'),
            'agency_name' => env('TRAVEL_API_AGENCY_NAME', env('APP_NAME', 'Karossy Travels')),
            'agency_city' => env('TRAVEL_API_AGENCY_CITY', 'Lagos'),
            'agency_country_code' => env('TRAVEL_API_AGENCY_COUNTRY_CODE', 'NG'),
            'agency_street' => env('TRAVEL_API_AGENCY_STREET'),
            'agency_postal_code' => env('TRAVEL_API_AGENCY_POSTAL_CODE'),
