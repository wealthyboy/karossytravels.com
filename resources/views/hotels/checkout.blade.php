...
<section class="booking-page"><div class="container public-container">
    ...
    @if($recoverableAttempt)<div class="alert alert-warning" role="alert"><strong>Payment confirmed.</strong> Do not pay again. Karossy support is completing this hotel confirmation. Reference: {{ $recoverableAttempt->reference }}</div>@endif
