...
<section class="public-hero" id="travel-search">
    ...
    <div class="container public-container position-relative">
        ...
        <div class="public-search-card">
            ...
            <div class="public-service-panel d-none" data-public-service-panel="cars"><div class="public-coming-search"><span><i class="bi bi-car-front"></i></span><div><strong>Drive with the Karossy network</strong><small>We are inviting professional drivers and vehicle owners to partner with us.</small></div><div class="public-coming-actions"><a class="btn btn-karossy" href="tel:{{ preg_replace('/\s+/', '', config('travel.cars.phone')) }}"><i class="bi bi-telephone"></i> Call {{ config('travel.cars.phone') }}</a><a class="btn btn-outline-dark" href="{{ route('cars.partners') }}">Join us</a></div></div></div>
            <div class="public-service-panel d-none" data-public-service-panel="charter"><div class="public-coming-search"><span><i class="bi bi-airplane-engines"></i></span><div><strong>Fly on your own schedule</strong><small>Request private, corporate and group charter options from our travel team.</small></div><div class="public-coming-actions"><a class="btn btn-karossy" href="tel:{{ preg_replace('/\s+/', '', config('travel.charter.phone')) }}"><i class="bi bi-telephone"></i> Call</a><a class="btn btn-outline-dark" href="mailto:{{ config('travel.charter.email') }}?subject=Charter%20flight%20request"><i class="bi bi-envelope"></i> Email</a></div></div></div>
        </div>
    </div>
</section>
    ...
    <div class="container public-container">
        <div class="home-charter-copy">
            ...
            <div class="home-charter-actions">
                <a class="btn btn-karossy" href="tel:{{ preg_replace('/\s+/', '', config('travel.charter.phone')) }}"><i class="bi bi-telephone"></i> Call {{ config('travel.charter.phone') }}</a>
                <a class="home-charter-contact" href="mailto:{{ config('travel.charter.email') }}?subject=Charter%20flight%20request&amp;body=Hello%20Karossy%2C%0A%0AI%20would%20like%20to%20request%20a%20charter%20flight.%0A%0ADeparture%3A%0ADestination%3A%0ATravel%20date%3A%0ANumber%20of%20passengers%3A%0A%0AThank%20you."><i class="bi bi-envelope"></i><span><small>Email our charter desk</small><strong>{{ config('travel.charter.email') }}</strong></span></a>
            </div>
        </div>
    </div>
</section>
