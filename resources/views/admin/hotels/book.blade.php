...
<form method="POST" action="{{ route('admin.hotels.orders.store', $offer) }}" class="admin-booking-form" id="hotel-booking-form">
    ...
    <div class="row g-4">
        ...
        <aside class="col-xl-4"><section class="admin-panel-card sticky-xl-top admin-order-summary" data-price-summary data-base-minor="{{ $offer->selling_total_minor }}">
            ...
            <button class="btn btn-karossy w-100" type="submit"><i class="bi bi-building-check me-2"></i>Create hotel booking</button><p class="admin-no-payment"><i class="bi bi-info-circle"></i> Karossy will price-check this rate and request live supplier confirmation before the booking is saved.</p>
        </section></aside>
    </div>
</form>
