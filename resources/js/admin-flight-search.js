...
if (page) {
    ...
    const filterShell = () => {
        ...
        results.innerHTML = `<button class="mobile-flight-filter-trigger" type="button" data-open-mobile-filters><i class="bi bi-sliders"></i><span>Filter</span></button><button class="mobile-flight-filter-overlay" type="button" aria-label="Close filters" data-close-mobile-filters></button><div class="admin-flight-results">
                ...
                ${isPublicResults ? `<aside class="flight-results-ad" aria-label="Gyro Air charter services"><a href="mailto:${encodeURIComponent(charterContact)}?subject=Gyro%20Air%20charter%20flight%20request"><img src="/images/ads/jiro-air-charter-v1.png" alt="Private jet at sunset" loading="lazy"><span class="jiro-ad-shine"></span><div class="jiro-ad-copy"><small><i></i> Private charter</small><strong>GYRO AIR</strong><h3>Your aircraft.<br>Your schedule.</h3><p>Private, corporate and group charter flights tailored around you.</p><b>Request a charter <i class="bi bi-arrow-up-right"></i></b></div></a></aside>` : ''}
            </div>
