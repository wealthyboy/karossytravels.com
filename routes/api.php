...
use App\Http\Controllers\Api\V1\BookingLookupController;
...
Route::prefix('v1')->name('api.v1.')->group(function (): void {
    ...
    Route::post('flights/offers/{offer}/checkout', [MobileCheckoutController::class, 'flight'])
        ->middleware('throttle:10,1')
        ->name('flights.checkout');
    Route::post('hotels/offers/{offer}/checkout', [MobileCheckoutController::class, 'hotel'])
        ->middleware('throttle:10,1')
        ->name('hotels.checkout');
    Route::get('payments/{attempt}/status', [MobileCheckoutController::class, 'status'])
        ->middleware('throttle:60,1')
    ...
    Route::post('auth/register', [MobileAuthController::class, 'register'])->middleware('throttle:5,1')->name('auth.register');
    Route::middleware('mobile.auth')->group(function (): void {
        ...
        Route::get('account/bookings', [MobileAuthController::class, 'bookings'])->name('account.bookings');
    });
